...
public class NewUserWithPermissionGranted {
    ...
    @Test
    public void registerUserValidatingAppNameAndLogout() {
        ...
        el6.click();
        MobileElement el7 = (MobileElement) driver.findElementByAccessibilityId("Sim");
        el7.click();
        MobileElement el8 = (MobileElement) driver.findElementByAccessibilityId("Sowe");
        assertEquals(el8.getAttribute("text"), "Sowe");
        MobileElement el9 = (MobileElement) driver.findElementByAccessibilityId("Botão Sair");
        el9.click();
    }
